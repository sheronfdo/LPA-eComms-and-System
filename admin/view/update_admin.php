    ...
    if (isset($_POST['submitbtn'])) {
        ...
        if (!empty($firstname) && !empty($lastname) && !empty($username) && !empty($password) && !empty($repassword)) {
            ...
            if ($password == $repassword) {
                ...
                $userService->setId($adminId);
                $userService->__constructwithoutId($username, $md5Password, $firstname, $lastname, $group);
                $userService->updateUser();
                echo '<script> alert("Admin Update Successfully"); </script>';
        ...
        <!-- /.navbar -->
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><h1 class="m-0">Update Administrator</h1></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <form action="update_admin.php" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            ?>">
                            <input type="text" name="admId" value="<?php echo $_POST['admid']; ?>" class="form-control" placeholder="" hidden >
